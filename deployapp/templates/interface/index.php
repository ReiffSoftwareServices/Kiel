	...
	<div class="nav-side-bar col-md-3">
		...
		<div class="brand"><img class="mb-4 mt-4" src="{% static 'geruestproject/img/logo.png' %}" alt="" width="144" ></div>
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						<a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#tab-new-scaffold" role="tab" aria-controls="v-pills-home" aria-selected="true"><i class="fas fa-plus-circle"></i> Gerüst-Anforderung</a>
						...
						<a class="nav-link" href="http://127.0.0.1:8000/admin/geruestproject/project/" role="tab" aria-controls="v-pills-settings" aria-selected="false"><i class="fas fa-table"></i> Datenansicht</a>
